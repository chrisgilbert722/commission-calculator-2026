        ...
        <div className="card" style={{
            ...
            <div className="text-center">
                ...
                <div style={{
                    ...
                    {formatCurrency(result.commissionEarned)}
                </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 'var(--space-2)', textAlign: 'center' }}>
                <div>
                    <div style={{ fontSize: '0.75rem', color: 'var(--color-text-muted)', fontWeight: 600 }}>TOTAL EARNINGS</div>
                ...
                <div style={{ borderLeft: '1px solid #86EFAC', borderRight: '1px solid #86EFAC' }}>
                    ...
                    <div style={{ fontWeight: 700, fontSize: '1.125rem' }}>
                        {result.effectiveCommissionRate.toFixed(1)}%
                    </div>
                </div>
                <div>
                    <div style={{ fontSize: '0.75rem', color: 'var(--color-text-muted)', fontWeight: 600 }}>TOTAL SALES</div>
                    <div style={{ fontWeight: 700, fontSize: '1.125rem' }}>
